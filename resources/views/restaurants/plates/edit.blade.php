	...
	<div class="container plates_create_page">
		...
		<form action="{{route('restaurants.plates.update', $plate->id)}}"
			...
			<div class="mb-4">
				...
				<textarea class="form-control" type="text" name="description" id="description">{{ old('description', $plate->description) }}</textarea>
				@error('description')
					<div class="text-danger fw-bold">{{ $message }}</div>
				@enderror
			</div>
			...
			<div class="mb-4">
				...
				<textarea class="form-control" type="text" name="ingredients" id="ingredients">{{ old('ingredients', $plate->ingredients) }}</textarea>
				@error('ingredients')
					<div class="text-danger fw-bold">{{ $message }}</div>
				@enderror
			</div>
			...
			<div class="mb-4">
				...
				<input class="form-control" type="number" name="price" id="price" min="0" step="0.1" value="{{ old('price', $plate->price)}}">
			</div>
